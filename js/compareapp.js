...
function item1(a)
{
  var select2 = document.getElementById("select2").value;
    if(a != select2)
    {
     ...
     document.getElementById('arrival1').innerHTML = products[a].arrival
        ...
        document.getElementById('arrival1').innerHTML = "N/A"
    }
}
function item2(b)
{
  var select1 = document.getElementById("select1").value;
    if(b != select1)
    {
     ...
     document.getElementById('arrival2').innerHTML = products[b].arrival
    }
    else{
        ...
        document.getElementById('size1').innerHTML = "N/A"
        document.getElementById('arrival2').innerHTML = "N/A"
    }
}